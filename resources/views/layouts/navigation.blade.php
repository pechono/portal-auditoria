            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->user()->rol === 'docente' ? route('docente.dashboard') : route('alumno.dashboard') }}">
                        <img src="/icons/logo-transparent.png" alt="Portal Auditoría" class="block h-9 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->rol === 'docente')
                        ...
                        <x-nav-link :href="route('docente.informe')" :active="request()->routeIs('docente.informe')">
                            Informe
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->rol === 'docente')
                ...
                <x-responsive-nav-link :href="route('docente.informe')" :active="request()->routeIs('docente.informe')">
                    Informe
                </x-responsive-nav-link>
